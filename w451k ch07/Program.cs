...
namespace w451k_ch07
{
    public class Program
    {
        ...
        {
            Renderer zzzz = new Renderer(' ', '+', '#', 71, 235);

            #region pudlo
//             Vector3 v1 = new Vector3(20, 20, 10);
//                          Vector3 v2 = new Vector3(20, 40, 10);
//                          Vector3 v3 = new Vector3(40, 40, 10);
//                          Vector3 v4 = new Vector3(40, 20, 10);
//                          Vector3 v5 = new Vector3(40, 20, 20);
//                          Vector3 v6 = new Vector3(20, 20, 20);
//                          Vector3 v7 = new Vector3(20, 40, 20);
//                          Vector3 v8 = new Vector3(40, 40, 20);
...
//                             zzzz.drawRectangleRaw(Pane2.convertPane3(pane3d6));
            ...
            zzzz.plotLine(new Line2(-1, -1, -1, -1));
            zzzz.plotLine(new Line2(-1, 1, -1, 1));
            zzzz.plotLine(new Line2(1, -1, 1, -1));
            zzzz.plotLine(new Line2(1, 1, 1, 1));
            zzzz.plotLine(new Line2(0, 0, 0, 0));
